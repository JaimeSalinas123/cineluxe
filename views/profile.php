...
<header>
   <div class="max-w-2xl mx-auto p-6">
        ...
        <div class="mb-10">
            <div class="flex flex-col md:flex-row md:justify-between md:items-center gap-6">
                ...
                <div class="flex items-center">
                    <div class="w-28 h-28 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden mr-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <button class="h-12 w-36 bg-blue-600 text-white rounded-lg hover:bg-blue-700 grid place-items-center">
                        <div class="flex items-center">
                            <i class="fas fa-upload mr-2"></i>
                            <span>Subir foto</span>
                        </div>
                    </button>
                    <button class="h-12 w-36 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 grid place-items-center">
                        <div class="flex items-center">
        ...
        <div class="mb-10">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="group">
                    ...
                    <div class="relative">
                        <input type="text" value="Través" 
                               class="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 pr-10 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                               readonly>
                ...
                <div class="group">
                    ...
                    <div class="relative">
                        <input type="text" value="Electrónica" 
                               class="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 pr-10 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                               readonly>
                        <button class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-blue-500">
                            <i class="fas fa-pencil-alt"></i>
                ...
                <div class="group md:col-span-2">
                    ...
                    <div class="relative">
                        <input type="email" value="traviescott@gmail.com" 
                               class="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 pr-10 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                               readonly>
                        <button class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-blue-500">
                            <i class="fas fa-pencil-alt"></i>
                ...
                <div class="group">
                    ...
                    <div class="relative">
                        <input type="tel" value="7543-2354" 
                               class="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 pr-10 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                               readonly>
                        <button class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-blue-500">
                            <i class="fas fa-pencil-alt"></i>
                ...
                <div class="group">
                    ...
                    <div class="relative">
                        <input type="text" value="30/04/1991" 
                               class="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 pr-10 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                               readonly>
                        <button class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-blue-500">
                            <i class="fas fa-pencil-alt"></i>
        ...
        <!-- Sección de Movies Summary -->
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-gray-800 mb-2">Movies Summary</h2>
            <p class="text-gray-600">Aquí podrás ver un resumen de tus películas favoritas y actividades recientes.</p>
        </div>

        <!-- Botón de Cerrar sesión -->
        <div class="flex justify-end pt-8">
            <button class="h-12 w-40 bg-red-600 text-white rounded-lg hover:bg-red-700 grid place-items-center">
                <div class="flex items-center">
